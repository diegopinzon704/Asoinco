<h1 class="letra4">Salida Activos Fijos o Elementos Fisicos</h1>
<form class="formuemple">
  ...
  <input class="btn btn-success letra3" type="submit" value="Salida Activo Fijo" name="ingresarproinventario">
  <a href="?c=Landing&a=elementosfisicos" class="btn btn-secondary">Atrás</a>
</form>
<br>
<table class="table">
  <thead>
